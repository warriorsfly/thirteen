...
abstract class DiscoverApi{
  ...
  /// 推荐歌单列表
  static const String RECOMMENT_LIST_URL = '${API.END_POINT}/recommend/resource';
  /// 歌单(网友精选碟)
  static const String TOP_NEW_LIST_URL = '${API.END_POINT}top/playlist?limit=10&order=new';
  /// 获取精品歌单
